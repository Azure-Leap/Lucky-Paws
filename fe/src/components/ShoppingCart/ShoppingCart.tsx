...
//   // const totalPrice: number = card?.items.map((a) => a.price).reduce(function (a, b) {
//   //   return a + b;
//   // });
//   return (
...
//                           >
//                             {ShoppingCart?.map((el) => (
//                               <li key={el.items._id} className="flex py-6">
//                                 <div className="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
//                                   {/* <img
//                                     src={el.items.imgList[0]}
//                                     alt="zurag"
...
//                                         </a>
//                                       </h3>
//                                       <p className="ml-4">$ {el.items.price}</p>
//                                     </div>
