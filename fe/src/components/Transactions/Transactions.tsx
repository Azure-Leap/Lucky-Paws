...
export const Transactions = () => {
  return (
    <div className='col-span-4 border-[1px] border-orange-400 rounded-3xl p-3'>
        <div className=''>
            <h1 className='text-xl font-bold'>Latest transactions</h1>
            <p className='text-base text-gray-500'>Table of latest transaction list</p>
        </div>
            ...
            <table className='w-full mx-auto text-left'>
                ...
                <tbody>
                    <tr>
                        ...
                        <td className='px-3 py-4 '><span className='bg-green-300 p-2 rounded-lg text-green-800 text-xs font-medium'>Completed</span></td>
                    </tr>
                    <tr>
                        <th scope='row' className='px-3 py-4 font-normal'>
                            Payment from <span className='font-bold'>Bonnie Green</span>
